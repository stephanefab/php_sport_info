...
if (!$is_match) {
    ...
    $match_type_id = $is_match['match_type_id'];
    $sport_id = $is_match['sport_id'];
    $team_home_id = $is_match['team_home_id'];
    $team_away_id = $is_match['team_away_id'];
    $score_home = $is_match['score_home'];
    $score_away = $is_match['score_away'];
    $match_date = $is_match['match_date'];
    $match_hour = $is_match['match_hour'];
    $status = $is_match['status'];
}
...
if (isset($_POST['submit_form'])) {
    ...
    $match_date = !empty($_POST['match_date']) ? $_POST['match_date'] : $match_date;
    $match_hour = !empty($_POST['match_hour']) ? $_POST['match_hour'] : $match_hour;
    ...
    if (!hasErrors()) {
        ...
        if (!hasErrors()) {
            ...
            if ($updated) {
                setFlashMessage("macth modifiée", "success");
            } else {
...
<div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-4">Modifier un macth</h2>
